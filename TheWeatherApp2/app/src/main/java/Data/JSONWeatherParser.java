...
public class JSONWeatherParser {
    ...
    public static Weather getWeather(String data){
        ...
        try {
            ...
            Log.d("testik","Json object= " + jsonObject);
            Location place = new Location();

            int code = Tools.getInt("cod", jsonObject);
            Log.d("testik","code = " + code);
            if (code != 404) {
               ...
               //dodelat error
                Log.d("testik","Json object2_0= " + jsonObject);

            Log.d("testik","code before setcode = " + code);
                weather.code.setCode(code);

            Log.d("testik","weather.code.getcode = " + weather.code.getCode());
